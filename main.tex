...
We arranged the detectors, source, and collimators in a similar fashion to the diagram of \figref{fig:Lab5_setupnot}, as can be seen in \figref{mat0_setup}.
...
In the `Settings' tab, we selected `Input' and `Discrimination' settings shown in \figref{fig:set_input} and \figref{set_discrim}; selected under `QDC' settings a gate of 800 ns, short gate of 400 ns, and pre-gate of 48 ns; and selected under `Onboard coincidences' settings a coincidence window of 96 ns.
